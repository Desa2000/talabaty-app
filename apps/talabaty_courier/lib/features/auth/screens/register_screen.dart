            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'انضم لأسطول توصيل طلباتي وابدأ استقبال طلبات التوصيل',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.cairo(
                      fontSize: 14,
                      ...
                      child: DropdownButton<VehicleType>(
                        ...
                        items: const [
                          DropdownMenuItem(
                            ...
                            child: Text('دراجة نارية (موتر)'),
                          ),
                          DropdownMenuItem(
                            value: VehicleType.electricBike,
                            child: Text('دراجة كهربائية'),
                          ),
                          DropdownMenuItem(
                            value: VehicleType.bicycle,
                            child: Text('دراجة هوائية'),
                          ),
                        ],
                        onChanged: (val) {
                          if (val != null)
                  ...
                  const SizedBox(height: 16),
                  if (_selectedVehicle == VehicleType.motorcycle)
                    _buildTextField(
                      controller: _licensePlateController,
                      hintText: 'رقم اللوحة المرورية / الرخصة',
