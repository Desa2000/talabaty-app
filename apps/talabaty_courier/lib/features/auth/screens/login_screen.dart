...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final Color hslGradientEnd = HSLColor.fromAHSL(
    ...
    1.0,
    0.50,
  ).toColor(); // Darker warm red-orange
  final Color hslCream = HSLColor.fromAHSL(
    1.0,
    25.0,
    0.85,
    0.97,
  ).toColor(); // Extremely soft cream
  final Color hslSoftGray = HSLColor.fromAHSL(
    1.0,
    240.0,
    0.05,
    0.94,
  ).toColor(); // Soft slate grey
      ...
      await authProvider.sendOtp(
        ...
        onCodeSent: () {
          if (mounted) {
            context.push(
              '/otp',
              extra: {'phone': formattedPhone, 'email': email},
            );
          }
        },
      );
          ...
          Positioned(
            ...
            child:
                Container(
                    ...
                    .animate()
                    .fade(duration: 1200.ms, delay: 200.ms)
                    .scale(
