              ...
              child: Column(
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage:
                        courierUser.profileImage != null &&
                            courierUser.profileImage!.startsWith('http')
              ...
              child: Column(
                children: [
                  _buildProfileItem(
                    ...
                    Icons.motorcycle,
                    'نوع المركبة',
                    courier.vehicleType == VehicleType.motorcycle
                        ? 'دراجة نارية'
                        : 'سيارة',
                  ),
                  ...
                  _buildProfileItem(
                    ...
                    Icons.pin,
                    'رقم اللوحة',
                    courier.vehiclePlate ?? 'غير متوفر',
                  ),
                  const Divider(height: 1),
                  _buildProfileItem(
                    context,
                    Icons.color_lens,
                    'لون المركبة',
                    courier.vehicleColor ?? 'غير متوفر',
                  ),
                ],
              ),
            ),
      ...
      onTap: isLink
          ? () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('قريباً: عرض التفاصيل')),
              );
            }
          : null,
    );
