...
import 'package:talabaty_customer/core/providers/cart_provider.dart';
                  ...
                  child: CircleAvatar(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('قريباً: مشاركة المطعم'),
                            behavior: SnackBarBehavior.floating,
                          ),
                        );
                      },
            ...
            if (filteredProducts.isEmpty)
              ...
              SliverPadding(
                padding: const EdgeInsets.symmetric(
                  horizontal: 16,
                  vertical: 12,
                ).copyWith(bottom: 120), // padding for floating cart
                sliver: SliverList(
...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(
    ...
    return Container(
      ...
      child: Center(
        child: Directionality(textDirection: TextDirection.rtl, child: _tabBar),
      ),
    );
  }
