import 'package:talabaty_customer/core/widgets/custom_image.dart';
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  final Color hslPrimary = HSLColor.fromAHSL(
    1.0,
    25.0,
    1.0,
    0.50,
                                  ...
                                  onTap: () {
                                    setState(() {
                                      ...
                                      if (!isSelected) {
                                        ...
                                        if (_selectedOptions[group.id]!.length <
                                            group.maxSelection) {
                                          _selectedOptions[group.id]!.add(
                                            option.id,
                                          );
                                        }
                                      } else {
                                        ...
                                        _selectedOptions[group.id]!.remove(
                                          option.id,
                                        );
                                      }
                                    });
                    ...
                    if (product.allowCustomerNotes) ...[
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText:
                              'مثال: بدون بصل، زيادة شطة، الطابق الثاني...',
                          ...
                          ? () {
                              if (!_validateRequiredOptions(product)) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'الرجاء اختيار الخيارات المطلوبة أولاً',
                                      style: GoogleFonts.outfit(
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
