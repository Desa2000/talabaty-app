          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color:
                      paymentProvider.selectedCardId == null ||
                          paymentProvider.selectedCardId!.isEmpty
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        if (paymentProvider.selectedCardId == null ||
                            paymentProvider.selectedCardId!.isEmpty)
                          const Icon(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color:
                  (isVisa ? const Color(0xFF26D0CE) : const Color(0xFF141E30))
