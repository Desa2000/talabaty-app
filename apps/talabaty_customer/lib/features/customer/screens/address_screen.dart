                      ...
                      onPressed: () {
                        ...
                        if (selected != null) {
                          Clipboard.setData(
                            ClipboardData(
                              text:
                                  '${selected.title}: ${selected.area}، ${selected.street}',
                            ),
                          );
                      ...
                      onPressed: () async {
                        if (addresses.length >= 3) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text(
                                'الحد الأقصى هو 3 مواقع. الرجاء حذف موقع لإضافة جديد.',
                              ),
                            ),
                          );
                          return;
              ...
              ElevatedButton(
                onPressed: () {
                  if (titleController.text.trim().isEmpty ||
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('يرجى تعبئة الاسم والمنطقة'),
                      ),
                    );
                    return;
                  }
