  ...
  static OrderModel orderFromJson(Map<String, dynamic> json) {
    return OrderModel(
      ...
      items:
          (json['items'] as List?)
              ?.map(
                (i) => cartItemFromJson(Map<String, dynamic>.from(i as Map)),
              )
              .toList() ??
          [],
      ...
      courierLat: json['courierLat'] != null
          ? (json['courierLat'] as num).toDouble()
          : null,
      courierLng: json['courierLng'] != null
          ? (json['courierLng'] as num).toDouble()
          : null,
      ...
      statusHistory:
          (json['statusHistory'] as List?)
              ?.map((h) => historyFromJson(Map<String, dynamic>.from(h as Map)))
              .toList() ??
          [],
    ...
    return CartItem(
      ...
      selectedAddOns:
          (json['selectedAddOns'] as List?)
              ?.map((a) => addOnFromJson(Map<String, dynamic>.from(a as Map)))
              .toList() ??
          [],
      notes: json['notes'] ?? '',
    );
    ...
    return ProductModel(
      ...
      optionGroups:
          (json['optionGroups'] as List?)
              ?.map(
                (g) => optionGroupFromJson(Map<String, dynamic>.from(g as Map)),
              )
              .toList() ??
          [],
      addOns:
    ...
    return ProductOptionGroup(
      ...
      options:
          (json['options'] as List?)
              ?.map((o) => optionFromJson(Map<String, dynamic>.from(o as Map)))
              .toList() ??
          [],
    );
  }
