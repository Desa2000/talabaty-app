  ...
  factory ApiException.fromDioException(DioException dioException) {
    ...
    switch (dioException.type) {
      ...
      case DioExceptionType.receiveTimeout:
        message =
            'فشلت عملية الاتصال بالخادم (انتهت المهلة). يرجى التحقق من اتصال الإنترنت.';
        break;
      ...
      case DioExceptionType.connectionError:
        message =
            'لا يوجد اتصال بالإنترنت أو الخادم غير متاح حالياً. يرجى التأكد من تشغيل السيرفر والشبكة.';
        break;
      ...
      default:
        if (dioException.error != null &&
          ...
          message =
              'تعذر الاتصال بالخادم. يرجى التأكد من تشغيل السيرفر وصحة عنوان الـ IP المكوّن.';
        } else {
