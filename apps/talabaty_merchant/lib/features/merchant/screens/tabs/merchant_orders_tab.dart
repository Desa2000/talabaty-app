            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'طلب #${order.id.length >= 4 ? order.id.substring(0, 4).toUpperCase() : order.id.toUpperCase()}',
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                builder: (ctx) => AlertDialog(
                                  ...
                                  content: const Text(
                                    'هل أنت متأكد من رفض هذا الطلب؟ سيتم إلغاؤه نهائياً.',
                                  ),
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(16),
                                  ),
