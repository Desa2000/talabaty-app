    ...
    try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              newValue
                  ? 'تم فتح المطعم بنجاح'
                  : 'تم إغلاق المطعم وإيقاف استقبال الطلبات',
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'حدث خطأ أثناء تحديث حالة المطعم',
  ...
  Future<void> _saveSettings(
    ...
    try {
      final updatedStore = StoreModel(
        ...
        landmark: _descController.text
            .trim(), // Use landmark field to store description
        latitude: double.tryParse(_latController.text) ?? currentStore.latitude,
        longitude:
            double.tryParse(_lngController.text) ?? currentStore.longitude,
  ...
  Widget build(BuildContext context) {
    ...
    if (_isInit) {
      ...
      _phoneController = TextEditingController(
        text: store.phone.isNotEmpty ? store.phone : merchantUser.phone,
      );
      ...
      _minOrderController = TextEditingController(
        text: store.minimumOrder.toInt().toString(),
      );
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            _isOpen
                                ? 'يستقبل طلبات العملاء الآن'
                                : 'لا يظهر للعملاء ولا يستقبل طلبات',
                            style: const TextStyle(
                              fontFamily: 'Cairo',
                              color: Colors.grey,
                              fontSize: 12,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: _buildTextField(
                        ...
                        label: 'وقت الإغلاق (مثال 11:00 PM)',
                  ...
                  children: [
                    Expanded(
                      child: _buildTextField(
                        ...
                        label: 'وقت التجهيز (مثال 30 دقيقة)',
