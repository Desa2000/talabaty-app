...
import { Download, Store, Zap, ShieldCheck, MapPin, Clock, Utensils, Truck } from "lucide-react";
...
export default function Hero() {
  ...
  const highlightBadges = [
    { icon: Zap, title: "سرعة التوصيل", subtitle: "خلال دقائق", bg: "bg-orange-50", text: "text-[#FF5722]", border: "border-orange-100" },
    { icon: ShieldCheck, title: "أمان وسهولة", subtitle: "دفع بالبنك والكاش", bg: "bg-emerald-50", text: "text-emerald-600", border: "border-orange-100" },
    { icon: MapPin, title: "تغطية واسعة", subtitle: "أقرب محلاتك", bg: "bg-blue-50", text: "text-blue-600", border: "border-orange-100", colSpan: "col-span-2 sm:col-span-1" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-right flex flex-col items-center lg:items-start">
            ...
            {/* Highlight Badges with Lucide Icons */}
          ...
          {/* Phone Visual Column — Clean Static Screen Mockup */}
          <div className="lg:col-span-5 relative flex justify-center items-center mt-10 lg:mt-0">
            ...
            <SlideIn direction="up" delay={0.4}>
              ...
              >
                {/* Clean Phone Frame */}
                <div 
                  className="relative w-[280px] sm:w-[310px] h-[560px] sm:h-[610px] bg-[#1A1D27] rounded-[48px] p-3 shadow-2xl shadow-orange-950/20 border-4 border-gray-800"
                    ...
                    <div className="relative w-full h-full bg-gray-100">
                      <AnimatePresence mode="wait">
                        ...
                        >
                          <Image
                            ...
                            alt={`Talabaty App Mobile Screen Preview ${currentScreen + 1}`}
                            fill
                      ...
                      <div className="absolute top-0 inset-x-0 bg-gradient-to-b from-black/60 via-black/20 to-transparent p-4 pt-6 text-white text-right z-10 pointer-events-none">
                        <div className="flex items-center justify-between text-xs font-bold">
                          <span className="bg-[#FF5722] px-2.5 py-0.5 rounded-full text-[10px] flex items-center gap-1">
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-[#FF5722] text-white flex items-center justify-center text-lg font-bold shadow-md shadow-orange-500/30">
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-emerald-600 text-white flex items-center justify-center text-lg font-bold shadow-md shadow-emerald-500/30">
